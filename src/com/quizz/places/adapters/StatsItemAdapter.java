...
//        TextView average;
    ...
    public int getItemViewType(int position) {
        return getItem(position).isAchievement() ? TYPE_ACHIEVEMENT_ITEM : TYPE_SIMPLE_ITEM;
    }
...
//					holder.average = (TextView) convertView.findViewById(R.id.StatPercentScore);
        ...
        if (stat.isAchievement() == true) {
			holder.icon.setImageDrawable(this.mContext.getResources().getDrawable(stat.getIcon()));
	       	holder.label.setText(String.valueOf(stat.getProgressInPercent()) + "% - " + stat.getLabel());
//	       	holder.average.setText(String.valueOf(stat.getProgressInPercent()) + "%");
	       	...
	       	if (stat.getDone() == stat.getTotal()) {
	       		holder.trophy.setImageDrawable(this.mContext.getResources().getDrawable(R.drawable.gold_cup));
	       	}
        } else {
    		holder.icon.setImageDrawable(this.mContext.getResources().getDrawable(stat.getIcon()));
