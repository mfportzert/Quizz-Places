...
public class MenuBackground extends View {
	...
	private void drawFoggyWindowWithTransparentCircle(Canvas canvas, Bitmap bitmap,
	...
	public void draw(Canvas canvas) {
		...
		for (int angle = 0; angle < 360; angle += 60) {
			...
			mCenterPoint.x = getWidth() / 2;
			mCenterPoint.y = (int) (getHeight() * 0.3f);
			drawFoggyWindowWithTransparentCircle(canvas, bitmap, mCenterPoint.x,
					mCenterPoint.y, getWidth() / 1.6f);
		}
	}
}
