 ...
 * @see SystemUiHider
 */
public class PictureFullscreenActivity extends Activity implements OnTouchListener  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		imageLoader.displayImage(QuizzPlacesApplication.IMAGES_DIR + "big_ben.jpg", 
