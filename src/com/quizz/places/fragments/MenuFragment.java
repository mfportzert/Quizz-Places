...
public class MenuFragment extends BaseMenuFragment {
	...
	FragmentTransaction fadeTransaction = getActivity().getSupportFragmentManager()
		.beginTransaction();
	...
	ObjectAnimator signPopup = ObjectAnimator.ofFloat(mTitleSign, "translationY",
		signMovementValues);
	...
	ObjectAnimator footerPopup = ObjectAnimator.ofFloat(mFooter, "translationY",
		footerMovementValues);
	...
	ObjectAnimator buttonsDisplay = ObjectAnimator.ofFloat(mMenuButtonsContainer, "alpha", 0f,
		1f);
	...
	ObjectAnimator buttonsHiding = ObjectAnimator.ofFloat(mMenuButtonsContainer, "alpha", 1f,
		0f);
